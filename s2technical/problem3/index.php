...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-color: #f4f6f8; /* Soft, modern light gray background */
            margin: 40px 20px;
            color: #1a1f2c;
            display: flex;
        ...
        table {
            ...
            border-spacing: 0;
            background: #ffffff;
            border-radius: 16px; /* Smooth rounded corners for the app frame */
            overflow: hidden;
            box-shadow: 0 10px 30px rgba(0, 0, 0, 0.05); /* Premium, soft card shadow */
        ...
        .header-bg {
            background: linear-gradient(135deg, #1a1f2c 0%, #2e3748 100%); /* Elegant premium dark gradient */
            color: #ffffff;
        }
